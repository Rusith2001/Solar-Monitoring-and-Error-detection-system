...
// --------------------------
const char* googleScriptURL = "https://script.google.com/macros/s/AKfycbwASgIPGe9_WTZUBGqHSpel18l5Whu2c0dPHwKOJXtzPh5HQBimB11omWW4t1ilZ1nH/exec";
...
void sendToFirebase(float voltage, float current, float power, float temperature, bool relayState) {
  String date = getDate();
  String timestamp = getFormattedTime();
  String path = "/modules/dc_module_1";
...
void updateRelayState() {
  String path = "/modules/dc_module_1/relayState";
