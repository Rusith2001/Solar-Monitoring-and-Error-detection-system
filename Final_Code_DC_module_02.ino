...
// --------------------------
const char* googleScriptURL = "https://script.google.com/macros/s/AKfycbzRMpyOoyMbeScgCu5R5lDXXG88fY4D7EMan3EKk6ww-9Dg4RzenvefYC-k9DDg5t5X/exec";
...
void sendToFirebase(float voltage, float current, float power, float temperature, bool relayState) {
  String date = getDate();
  String timestamp = getFormattedTime();
  String path = "/modules/dc_module_2";
...
void updateRelayState() {
  String path = "/modules/dc_module_2/relayState";
